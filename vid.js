  ...
  function p(e, n) {
    ...
    for (t = 0; t < o; t += 16)
      (c = [
        ...
        (c = f((c = m(c, l)), 31)),
        (i = d((i = f((i = h(i, (c = m(c, s)))), 27)), a)),
        (i = d(m(i, [0, 5]), [0, 1390208809])),
        (u = f((u = m(u, s)), 33)),
        (a = d((a = f((a = h(a, (u = m(u, l)))), 31)), i)),
    ...
    switch (((c = [0, 0]), (u = [0, 0]), r)) {
      ...
      case 1:
        (c = m((c = h(c, [0, e.charCodeAt(t)])), l)),
          (i = h(i, (c = m((c = f(c, 31)), s))));
    }
    return (
      (i = d((i = h(i, [0, e.length])), (a = h(a, [0, e.length])))),
      (a = d(a, i)),
      (i = d((i = b(i)), (a = b(a)))),
      (a = d(a, i)),
                ...
                return new Promise(function (e) {
                  ...
                  u(i, function () {
                    for (var t = [], r = 0; r < arguments.length; r++)
                      t[r] = arguments[r];
                    var i = o + Date.now() - n;
                    if (!t[0]) return e({ error: V(t[1]), duration: i });
    ...
    return (
      (function () {
        if (void 0 === z) {
          var e = function () {
            var n = T();
            B(n) ? (z = setTimeout(e, 2500)) : ((N = n), (z = void 0));
          };
          e();
        }
      })(),
    ...
    fonts: function () {
      return j(function (e, n) {
        ...
        for (var s = 0; s < J.length; s++)
          (i[J[s]] = u[s].offsetWidth), (a[J[s]] = u[s].offsetHeight);
        ...
        return j(function (t, r) {
          ...
          (c.width = n + "px"),
            ...
            F()
              ...
              : Y() && (a.style.zoom = "reset");
          var u = i.createElement("div");
          return (
            (u.textContent = o(Array((n / 20) << 0))
              .map(function () {
                return "word";
              })
              .join(" ")),
              ...
              case 1:
                return (
                  ...
                  (u = (function (e) {
                    ...
                    return {
                      get visitorId() {
                        return void 0 === n && (n = ie(this.components)), n;
                      },
                      set visitorId(e) {
                        n = e;
                      },
    ...
    return t(this, void 0, void 0, function () {
      return r(this, function (e) {
        switch (e.label) {
                ...
                (function () {
                  if (!(window.__fpjs_d_m || Math.random() >= 0.001))
                    try {
                      ...
                      e.open(
                        "get",
                        "https://m1.openfpcdn.io/fingerprintjs/v3.3.6/npm-monitoring",
                        !0
                      ),
                        e.send();
                    } catch (n) {
          ...
          case 1:
            return e.sent(), [2, ce(W(te, { debug: i }, []), i)];
        }
      });
    });
  }
  var le = { load: ue, hashComponents: ie, componentsToDebugString: oe },
    se = p;
  return (
    (e.componentsToDebugString = oe),
    (e.default = le),
    (e.getFullscreenElement = M),
    (e.getScreenFrame = D),
    (e.hashComponents = ie),
    (e.isAndroid = G),
    (e.isChromium = F),
